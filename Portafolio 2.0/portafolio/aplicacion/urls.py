...
urlpatterns = [
    ...
    path(
     ...
     path(
        'reservando-update/<pk>/',
         views.ActualizarReservaView.as_view(),
          name='reservando-update'
          ),
     path(
        'reservando-delete/<pk>/',
         views.EliminarReservaView.as_view(),
          name='reservando-delete'
          ),
     path(
        'reservando-delete_all/',
         views.ReservaDeleteAll.as_view(),
          name='reservando-delete_all'
          ),
     path(
        'reserva-simple/',
         views.ProcesoReservaView.as_view(),
          name='reserva-simple'
          ),
     path(
        'reserva-voucher/',
     ...
     path(
        'voucher/<pk>/',
         views.ReservaVoucherPdf.as_view(),
          name='reserva-voucher_pdf'
          ),
     path(
        'ventasreserva/',
         views.ListaVentaView.as_view(),
          name='ventasreserva'
          ),
     path(
        'cancelarventa/<pk>/',
